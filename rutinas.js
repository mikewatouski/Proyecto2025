...
dayBtnsEdit.forEach(b=>{
  ...
  if (mode === 'edit') {
    editDiaSpan.textContent = day;   // <— asegura que diga “Edición rutina día Sábado”
  }

  if (!opts.skipRender){
    if (mode === 'view') { renderView(); }
    else { renderEdit(); renderLists(); }   // <— al entrar a editar, también refrescá la vista previa
  }
}
  ...
  { nombre:"Curl martillo", peso:12, reps:12, img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVaRHl3zzhXaLFoW0UhI915d6KcONr-2pOAw&s" }
       ...
       "Miércoles":[{ nombre:"Sentadilla", peso:45, reps:10, img:"https://static.strengthlevel.com/images/exercises/squat/squat-800.jpg" },
